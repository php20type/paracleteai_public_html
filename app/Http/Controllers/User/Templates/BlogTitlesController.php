    ...
    public function createBlogTitlesPrompt($description, $language) {
        ...
        switch ($language) {
            ...
            case 'sl-SI':
                ...
                break;
            case 'th-TH':
                $prompt = "สร้างชื่อบล็อกที่ดึงดูดใจ 10 ชื่อสำหรับ:\n\n" . $description. "\n\n";
                return $prompt;
                break;
            case 'uk-UA':
                $prompt = "Створіть 10 привабливих назв блогу для:\n\n" . $description. "\n\n";
                return $prompt;
                break;
            case 'lt-LT':
                $prompt = "Sukurkite 10 patrauklių tinklaraščio pavadinimų:\n\n" . $description. "\n\n";
                return $prompt;
                break;
            case 'bg-BG':
                $prompt = "Генерирайте 10 закачливи заглавия на блогове за:\n\n" . $description. "\n\n";
                return $prompt;
                break;
            default:
                # code...

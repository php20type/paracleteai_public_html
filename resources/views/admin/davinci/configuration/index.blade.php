				...
				<div class="card-body">
					...
					<form action="{{ route('admin.davinci.configs.store') }}" method="POST" enctype="multipart/form-data">
						...
						<div class="row">							
							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="input-box">	
									<h6>{{ __('Default OpenAI Model') }} <span class="text-muted">({{ __('For Admin Group') }})</span><span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
										...
										<option value="gpt-3.5-turbo" @if ( config('settings.default_model_admin')  == 'gpt-3.5-turbo') selected @endif>{{ __('ChatGPT') }} ({{ __('3.5 Turbo') }})</option>
							...
							{{-- <div class="col-lg-6 col-md-6 col-sm-12">
								<div class="input-box">
									<h6>{{ __('Chat Feature') }} <span class="text-muted">({{ __('For User & Subscriber Groups') }})</span> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">	
											...
											<select id="default-model-user" name="default-model-user" data-placeholder="{{ __('Select Default Model') }}:">			
												...
												<option value="gpt-3.5-turbo" @if ( config('settings.default_model_user')  == 'gpt-3.5-turbo') selected @endif>{{ __('ChatGPT') }} ({{ __('3.5 Turbo') }})</option>
